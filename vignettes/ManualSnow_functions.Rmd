---
title: "Manual Snow Data Function"
...
The user can also specify the year (water year) that the function retrieves. Note water year is the same as calendar year as  as there aren't any manual snow surveys done within October - December of the previous calendar year.
...
# Function will retrieve all data from the Data Catalgue and save a version of the historic data at the directory specified.
