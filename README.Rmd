...
3. force: Specifies whether you want to update the archive of ASWE data that is saved on your computer to speed up the data process. If the data within the archive on the users
